...
public interface DatabaseController {
     ...
     */
    int insert(String query, List<?> vars) throws SQLException;
     ...
     * object is ambiguous or the SQL statement returns a ResultSet object.
     */
    int insert(List<String> queries, List<List<?>> varsList) throws SQLException;
     ...
     * object.
     */
    ResultSet select(String query, List<?> vars) throws SQLException;
